...
#include "vunary-microkernel-tester.h"
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X4, batch_eq_4) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x4, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X4, batch_div_4) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X4, batch_lt_4) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X4, batch_gt_4) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 4 + 1; batch_size < 8; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X4, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X8, batch_eq_8) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x8, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X8, batch_div_8) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X8, batch_lt_8) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X8, batch_gt_8) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 8 + 1; batch_size < 16; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X8, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X12, batch_eq_12) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(12)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x12, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X12, batch_div_12) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 24; batch_size < 120; batch_size += 12) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X12, batch_lt_12) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 12; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X12, batch_gt_12) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 12 + 1; batch_size < 24; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X12, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 60; batch_size += 11) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X16, batch_eq_16) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x16, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X16, batch_div_16) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X16, batch_lt_16) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X16, batch_gt_16) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 16 + 1; batch_size < 32; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X16, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X20, batch_eq_20) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(20)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x20, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X20, batch_div_20) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 40; batch_size < 200; batch_size += 20) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X20, batch_lt_20) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 20; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X20, batch_gt_20) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 20 + 1; batch_size < 40; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X20, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 100; batch_size += 19) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X24, batch_eq_24) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x24, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X24, batch_div_24) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 48; batch_size < 240; batch_size += 24) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X24, batch_lt_24) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 24; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X24, batch_gt_24) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 24 + 1; batch_size < 48; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_FMA_RR2_P5_DIV_X24, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 120; batch_size += 23) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X4, batch_eq_4) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x4, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X4, batch_div_4) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 8; batch_size < 40; batch_size += 4) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X4, batch_lt_4) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 4; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X4, batch_gt_4) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 4 + 1; batch_size < 8; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X4, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 20; batch_size += 3) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X8, batch_eq_8) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x8, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X8, batch_div_8) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X8, batch_lt_8) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X8, batch_gt_8) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 8 + 1; batch_size < 16; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X8, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X12, batch_eq_12) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(12)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x12, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X12, batch_div_12) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 24; batch_size < 120; batch_size += 12) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X12, batch_lt_12) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 12; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X12, batch_gt_12) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 12 + 1; batch_size < 24; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X12, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 60; batch_size += 11) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X16, batch_eq_16) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x16, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X16, batch_div_16) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X16, batch_lt_16) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X16, batch_gt_16) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 16 + 1; batch_size < 32; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X16, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X20, batch_eq_20) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(20)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x20, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X20, batch_div_20) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 40; batch_size < 200; batch_size += 20) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X20, batch_lt_20) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 20; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X20, batch_gt_20) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 20 + 1; batch_size < 40; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X20, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 100; batch_size += 19) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_WASMRELAXEDSIMD
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X24, batch_eq_24) {
    TEST_REQUIRES_WASM_BLEND;
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x24, xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params);
  }

  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X24, batch_div_24) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 48; batch_size < 240; batch_size += 24) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X24, batch_lt_24) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size < 24; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X24, batch_gt_24) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 24 + 1; batch_size < 48; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSIGMOID__WASMBLEND_RR2_P5_DIV_X24, inplace) {
    TEST_REQUIRES_WASM_BLEND;
    for (size_t batch_size = 1; batch_size <= 120; batch_size += 23) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
