  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_fma_rr2_p5_div_x4,
                    xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x4,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_fma_rr2_p5_div_x8,
                    xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x8,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_fma_rr2_p5_div_x12,
                    xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x12,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_fma_rr2_p5_div_x16,
                    xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x16,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_fma_rr2_p5_div_x20,
                    xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x20,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_fma_rr2_p5_div_x24,
                    xnn_f32_vsigmoid_ukernel__wasmblend_fma_rr2_p5_div_x24,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  ...
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_rr2_p5_div_x4,
                    xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x4,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_rr2_p5_div_x8,
                    xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x8,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_rr2_p5_div_x12,
                    xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x12,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_rr2_p5_div_x16,
                    xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x16,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_rr2_p5_div_x20,
                    xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x20,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsigmoid, wasmblend_rr2_p5_div_x24,
                    xnn_f32_vsigmoid_ukernel__wasmblend_rr2_p5_div_x24,
                    xnn_init_f32_sigmoid_wasmsimd_rr2_p5_params,
                    benchmark::utils::CheckWAsmBLEND)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
